...
#ifdef FAKE_DATA
unsigned long fake_duration = 1000;  // 1000ms
int increase = 50;
#endif
/**
...
void setup() {
  ...
  char deviceName[30];
  sprintf(deviceName, "CSC_%02X%02X%02X", mac[3], mac[4], mac[5]);

  BLE.setDeviceName(deviceName);
  BLE.setLocalName(deviceName);   // for advertising
